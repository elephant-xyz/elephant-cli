...
describe('IPLDCanonicalizerService', () => {
  ...
  describe('IPLD link sorting', () => {
    ...
    it('should handle arrays with mixed IPLD links and other values', () => {
      ...
      expect(parsed.mixed[0]["/"]).toBe("bafybeibazaarhe5qpbgvfwqnteba5hbgzvqcajqgfgxnhpdvfnqweabk4u");
      expect(parsed.mixed[1]["/"]).toBe("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi");
    ...
    it('should recursively sort nested arrays with IPLD links', () => {
      ...
      expect(parsed.outer[0].inner[0]["/"]).toBe("bafybeibazaarhe5qpbgvfwqnteba5hbgzvqcajqgfgxnhpdvfnqweabk4u");
      expect(parsed.outer[0].inner[1]["/"]).toBe("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi");
    });
    ...
    it('should handle arrays containing only IPLD links', () => {
      ...
      expect(parsed[0]["/"]).toBe("QmPZ9gcCEpqKTo6aq61g2nXGUhM4iCL3ewB6LDXZCtioEB");
      expect(parsed[1]["/"]).toBe("QmWATWQ7fVPP2EFGu71UkfnqhYXDYH566qy47CnJDgvs8u");
      expect(parsed[2]["/"]).toBe("QmYjtig7VJQ6XsnUjqqJvj7QaMcCAwtrgNdahSiFofrE7o");
    });
    ...
    it('should handle empty arrays and null values', () => {
      const input = {
        ...
        arrayWithNull: [{ "/": "bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi" }, null]
      };
      ...
      expect(parsed.arrayWithNull[0]["/"]).toBe("bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi");
    ...
    it('should handle complex nested structures', () => {
      const input = {
        data: {
          references: [
            {
              metadata: { "/": "bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi" },
              links: [
                { "/": "bafybeifx7yeb55armcsxwwitkymga5xf53dxiarykms3ygqic223w5sk3m" },
                { "/": "bafybeibazaarhe5qpbgvfwqnteba5hbgzvqcajqgfgxnhpdvfnqweabk4u" }
              ]
      ...
      expect(parsed.data.references[0].links[0]["/"]).toBe("bafybeibazaarhe5qpbgvfwqnteba5hbgzvqcajqgfgxnhpdvfnqweabk4u");
      expect(parsed.data.references[0].links[1]["/"]).toBe("bafybeifx7yeb55armcsxwwitkymga5xf53dxiarykms3ygqic223w5sk3m");
      
      // Check main links sorting
      expect(parsed.data.mainLinks[0]["/"]).toBe("QmPZ9gcCEpqKTo6aq61g2nXGUhM4iCL3ewB6LDXZCtioEB");
      expect(parsed.data.mainLinks[1]["/"]).toBe("QmYjtig7VJQ6XsnUjqqJvj7QaMcCAwtrgNdahSiFofrE7o");
    });
  });
